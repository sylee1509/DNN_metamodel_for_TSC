    ...
    for idx in df_parameter.index:
        ...
        for scen in test_scen:
            ...
            for random_idx in range(10):
                # J1
                while True:
                    split = [random.randint(5, 120) for _ in range(4)]
            ...
            history.to_csv(input_data, f'output/all_{target}_{idx}_{scen[0]}.csv', replication)


if __name__ == "__main__":
    filename = 'parameter_sample_network.csv'
    scenario_filename = 'scenarios_sample.csv'
